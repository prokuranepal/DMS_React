...
export const GET_REGULATORY_BODIES = 'GET_REGULATORY_BODIES';
export const ADD_REGULATORY_BODY = 'GET_REGULATORY_BODY';
export const GET_HOSPITAL_USERS = 'GET_HOSPITAL_USERS';
export const GET_REGULATORY_USERS = 'GET_REGULATORY_USERS';

export const UPDATE_HEALTHPOSTS_SUCCESS = 'UPDATE_HEALTHPOSTS_SUCCESS';
...
export const GET_SELF_USER_DATA = 'GET_SELF_USER_DATA';
export const UPDATE_SELF_USER_DATA = 'UPDATE_SELF_USER_DATA';
...
export const GET_FLIGHT_CARDS_SUCCESS = 'GET_FLIGHT_CARDS_SUCCESS';
