...
* In your terminal run    ```git remote add origin https://github.com/user_name/DMS_React```
* Also run    ```git remote add upstream https://github.com/prokuranepal/DMS_React.git```
